...
it(`Should change activeElement when call cities`, () => {
  ...
  expect(wrapper.props().activeElement).toEqual(wrapper.props().elements[0]);

  wrapper.props().onElementActivate(wrapper.props().elements[1]);
  expect(wrapper.props().activeElement).toEqual(wrapper.props().elements[1]);

  wrapper.props().onElementActivate(wrapper.props().elements[2]);
  expect(wrapper.props().activeElement).toEqual(wrapper.props().elements[2]);
